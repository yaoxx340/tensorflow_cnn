...
path='/home/yuan/Google Drive/Research/cv/CNN_detector/train/'
...
for epoch in range(n_epoch):
	...
	x_train_a = np.reshape(x_train_a,(batch_size,100,100,1))
	...
	x_val_a = np.reshape(x_val_a,(batch_size,100,100,1))
